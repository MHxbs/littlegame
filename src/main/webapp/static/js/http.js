...
function getApi(key){
    var apis = {};
    apis['POST-POINT'] = ' http://hong.s1.natapp.cc/EndServlet';//每死一次就保存分数数据地址
    apis['GET-RANK'] = 'http://hong.s1.natapp.cc/RankServlet';//获得排行榜数据和个人排名
    apis['USER-INFO'] = ' http://hong.s1.natapp.cc/StartServlet';//每次开始游戏获取用户数据
    apis['SHARE'] = '';//这个不填
